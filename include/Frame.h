...
#define FRAME_GRID_COLS 64
    ...
    public:
        ...
        inline bool HasReferenceKeyFrame() const
        {
            return mpReferenceKF != NULL;
        }

        inline KeyFrame *GetReferenceKeyFrame() const
        {
            return mpReferenceKF;
        }

        inline std::vector<MapPoint *> GetMapPoints() const
        {
            return mvpMapPoints;
        }
