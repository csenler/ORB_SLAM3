...
namespace ORB_SLAM3
{
    ...
    public:
        ...
        vector<KeyFrame *> DetectRelocalizationCandidates(Frame *F, Map *pMap, const float accuracyFactor, const float minCommonWordsFactor); // in order to change accuracy
